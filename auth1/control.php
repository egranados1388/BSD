<?
     ...
     if($nmyusuario != 0){
		  ...
		  ?>
              <script language='JavaScript'>alert('La contrase\u00f1a del usuario no es correcta.')</script>
               <script language='JavaScript'> window.location.href=index.php </script>
		<?
          }
     }else{
          echo"<script language='JavaScript'>alert('El usuario no existe.');window.location.href=\"index.php\"</script>";
     }
     mysql_close($link);
?>
