...
function  get_camposQry($cliente)
	{
		...
		$valor= " select ";
			...
			if( $conn ) 
			{
			 ...
			 $sql = "select * from setup_EPCLI_E10 where  userID='$cliente'";
			 $params = array();
...
//-------------------------------------
    ...
    and  (OrderDtl.PartNum = Part.PartNum )     and  OrderHed.OrderNum >= 1 ".$cliente_str." ".$tipo_str." ".$fs.$tipo_prod.$exis.$otstr.$ocstr."  and  JobProd.JobNum <> '' GROUP BY    JobProd.JobNum Order By MAX(OrderDtl.NeedByDate) Desc";
	}
	else
	{
...
<div align="center">
  <h2>   EPC (Estado de Pedido)1.0 E10</h2>
