...
class Example2 extends Common
{
	...
	function displayHtml()
	{
		?>
			...
			<div id="historyContainer">
				...
				<div id="titleLayer" style="padding: 2px; font-weight: bold; font-size: 18px; text-align: center;">vbvb
				</div>
	...
	function initiateEditor()
	{
		...
		$tableColumns['employee_id'] = array('display_text' => 'Nombre', 'perms' => 'EVCTAXQ', 'join' => array('table' => 'employees', 'column' => 'id', 'display_mask' => "concat(employees.first_name,' ',employees.last_name)", 'type' => 'left'));
		$tableColumns['login'] = array('display_text' => 'Login', 'perms' => 'EVCTAXQ', 'req' => true);
