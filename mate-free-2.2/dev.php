...
class Example2 extends Common
{
	...
	{
		$tableColumns['folio'] = array('display_text' => 'Folio', 'perms' => '');
		$tableColumns['nombre_solicitud'] = array('display_text' => 'NombreSolicitud', 'perms' => 'EVCTAXQ');
		$tableColumns['estatus'] = array('display_text' => 'Estatus', 'perms' => 'EVCTAXQ', 'req' => true);
		$tableColumns['solicitante'] = array('display_text' => 'Solicitante', 'perms' => 'EVCAXQT','mysql_add_fun' => 'PASSWORD','mysql_edit_fun' => 'PASSWORD'); 
		$tableColumns['fecha_solicitud'] = array('display_text' => 'Fecha Solicitud', 'perms' => 'EVCTAXQ'); 
		$tableColumns['fecha_entrega'] = array('display_text' => 'Fecha Entrega', 'perms' => 'EVCTAXQ'); 
		...
		$this->Editor->setConfig('orderByColumn','folio');
	}
