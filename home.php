<?php
/************************************despliegue de  tabla  nivel administrador************************
...
class Example2 extends Common
{
	...
	function displayHtml()
	{
		...
		<?php include("seguridad.php"); ?>
			<div align="left" style="position: relative;"><div id="ajaxLoader1"><img src="images/ajax_loader.gif" alt="Loading..." /></div>
			...
			<table border="0" width="100%"><tr><td width="10%"><img src="images/cartomicro_logo.png" width="100" height="80"> </td><td width="44%">
			<p class="labelCell">Bienvenido <?php echo $_SESSION["usuarioactual"];?></p ></td><td width="32%" align=right>  </td>
			</tr><tr><td> <a href=user.php>Modo Usuario</a></td><td><a href=ayuda.docx>Ayuda</a></td><td  align="right"><a href=eficiencia.php>Indicadores</a></td>
			</tr>
			<tr> <td colspan=4 align=center><img src=images/Estados/cero_nvo.png width=20 height=20>(0)Nuevo <img src=images/Estados/uno_nvodoc.png width=20 height=20>(1)En Seguimiento<img src=images/Estados/dos_desa.png width=20 height=20>(2)En Desarrollo<img src=images/Estados/tres_prueba.png width=20 height=20>(3)Fase de prueba<img src=images/Estados/cuatro_pendiente.png width=20 height=20>(4)Pendiente<img src=images/Estados/cinco_cancelado.png width=20 height=20>(5)Cancelado<img src=images/Estados/seis_concluido.png width=20 height=20>(6)Concluido</td></tr>
			</p>
			</table>
	...
	{
		$tableColumns['int_num'] = array('display_text' => 'ID', 'perms' => 'TVQSXO','col_header_info' => 'width="30"');
		$tableColumns['folio'] = array('display_text' => 'Folio', 'perms' => 'EVCTAXQSHO', 'req' => true, 'default' => date("Y"),'col_header_info' => 'width="50"' );
		$tableColumns['nombre_solicitud'] = array('display_text' => 'NombreSolicitud', 'perms' => 'EVCTAXQSHO','col_header_info' => 'width="80"');
		$tableColumns['estatus'] = array('display_text' => 'Estatus', 'perms' => 'EVCTAXQSHO','default' => '0','col_header_info' => 'width="50"');
		$tableColumns['solicitante'] = array('display_text' => 'Solicita', 'perms' => 'EVCTAXQSHO','col_header_info' => 'width="100"'); 
	       $tableColumns['asignado'] = array('display_text' => 'Atiende', 'perms' => 'EVCTAXQSHO','col_header_info' => 'width="70"' );
...
$tableColumns['fecha_inicio'] = array('display_text' => 'Fecha Inicial', 'perms' => 'EVCTAXQSHO','display_mask' => 'date_format(fecha_inicio,"%d - %m - %Y")', 'order_mask' => 'desarrollos.fecha_inicio', 'calendar' => '%d %B %Y','col_header_info' => 'width="100"'); 
		...
		$tableColumns['prioridad'] = array('display_text' => 'Prioridad', 'perms' => 'EVCTAXQSHO','default' => '0' ,'col_header_info' => 'width="30"' );
		$tableColumns['Observaciones'] = array('display_text' => 'Detalles', 'perms' => 'VA');
		$tableColumns['archivo'] = array('display_text' => 'Anexos', 'perms' => 'VA');
				
		$tableName = 'desarrollos';
		$primaryCol = 'int_num';
		$errorFun = array(&$this,'logError');
		
		  $permissions = 'EAVDQCSXHOMUTFIV';
		...
		$this->Editor->setConfig('addRowTitle','Nuevo Ticket');
		$this->Editor->setConfig('editRowTitle','Editar  Ticket');
		$this->Editor->setConfig('iconTitle','Opciones');
